 ...
 * Use the [FragmentRequest.newInstance] factory method to
...
class FragmentRequest : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v=inflater.inflate(R.layout.fragment_request, container, false)

        var r=v.findViewById<RecyclerView>(R.id.rec_request)
